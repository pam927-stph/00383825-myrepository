...
int main()
{
    ...
    do {
        ...
        cout << "1. Clasificar los numeros en pares e impares " << endl;
        cout << "2. Ordenar los archivos" << endl;
        cout << "3. Ver los resultados" << endl;
        ...
        switch (opcion) {
            ...
            case 2:
                ...
                cout << endl << "Los archivos fueron ordenados." << endl;
                break;

            case 3:
                cout << endl << "MOSTRANDO EL CONTENIDO DE LOS ARCHIVOS:" << endl;
            ...
            default:
                cout << endl << "Opcion invalida, intentar de nuevo." << endl;
                break;
        }
...
void ordenarArchivo(const string& nombreArchivo) {
    ...
    if (!archivo) {
        cout << "No fue posible abrirlo " << nombreArchivo << endl;
        return;
    }
